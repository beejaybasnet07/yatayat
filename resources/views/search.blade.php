      ...
      <div class="container ">
        ...
        <div class="row ">
          <div class="col-md-4">
            ...
            <p class="text-danger">{{ucfirst($data->from)}}</p>

          </div>
          <div class="col-md-3">
            <p class="text-danger">{{$data->date}}</p>
          </div>
          <div class="col">
            <p class="text-danger">{{$data->to}}</p>
          </div>
          <!--
          <div class="col-md-4 ">
                ...
                <form method="get" action="check" name="form{{$data->id}}" onclick="getform(this)" id="form1">
                  <div class=" row mt-2">
                    ...
                    <div class="col  col-1 ml-3">
                      <i class="fas fa-circle fa-1x" style="color:#5bcd3e; margin-top:10px"><span style="color:teal">Selected</span></i>
                    </div>
                    <div class="col  col-1 ml-3 ">
                  ...
                  <div class="row">
                    ...
                    <div class="col col-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="A2{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "A2" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?>onchange="return validate(this)">
                      </div>
                    ...
                    <div class="col col-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="A3{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "A3" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?>onchange="return validate(this)">
                  ...
                  <div class="row mt-5">
                    <div class="col col-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="A5{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "A5" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?> onchange="return validate(this)">
                    ...
                    <div class="col col-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="A6{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "A6" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?>onchange="return validate(this)">
                    ...
                    <div class="col col-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="A7{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "A7" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?>onchange="return validate(this)">
                    ...
                    <div class="col col-1">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="A8{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "A8" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?> placeholder="{{$bookval->seat}}" onchange="return validate(this)">
                      </div>
                    </div>
                    <div class="col col-1">

                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="A9{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "A9" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?>onchange="return validate(this)">
                  ...
                  <div class="row mt-5">
                    <div class="col col-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="B1{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "B1" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?> onchange="return validate(this)">
                      </div>
                    ...
                    <div class="col col-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="B2{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "B2" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?>onchange="return validate(this)">
                      </div>
                    ...
                    <div class="col col-1 offset-2">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="B3{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "B3" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?>onchange="return validate(this)">
                      </div>
                  ...
                  <div class="row mt-5">
                    <div class="col col-1 offset-2">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="B4{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "B4" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?>onchange="return validate(this)">
                      </div>
                    ...
                    <div class="col col-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="B5{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "B5" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?>onchange="return validate(this)">
                      </div>
                    ...
                    <div class="col col-1">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="check1" name="check" value="B6{{$data->id}}" <?php foreach ($books as $bookval) {
                                                                                                                            if (($bookval->seat) == "B6" . $data->id) {
                                                                                                                              echo "disabled style='background-color : red ;cursor:text'";
                                                                                                                            }
                                                                                                                          } ?> onchange="return validate(this)">
                      </div>
              ...
              <div class="row mt-5 mb-5">
                ...
                <div class="col-3">
                  ...
                  <div class="collapse" id="dropping">
                    <div class="card card-body p-0">
                      <ul>
                        <li>Itahari(Rs 1,000)</li>
                        <li>Damak(Rs 1,000)</li>
                      </ul>
                    </div>
                  </div>
                </div>
